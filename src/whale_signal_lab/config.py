...
class PaperConfig:
    ...
    loss_streak_limit: int = 1
    loss_streak_cooldown_ticks: int = 96
    loss_streak_position_scale: float = 0.25
    ...
    scout_min_readiness: float = 0.70
    scout_min_priority: float = 0.58
